		...
		<div id="mpiblock">
			<div>
				...
				if($dpwapObj->dpwap_app_DirTesting()){} 
					...
					<div class="mpi_error">
						<?php esc_html_e('oops!!! Seems like the directory permission are not set right so some functionalities of plugin will not work.', 'dpwap');?>
						<br/>
						<?php esc_html_e('Please set the directory permission for the folder "uploads" inside "wp-content" directory to 777.', 'dpwap');?>
					</div><?php
				} ?>
			</div>
			<div id="dpwap-plugin-box" class="dpwap-meta-box">
				<div class="postbox">
					...
					<div id="dpwap-plugin-zipbox">
						<h3 class="hndle">
							<span>
								<?php esc_html_e('You can select and upload multiple Plugins in .zip format','dpwap'); ?>
							</span>
						</h3>
						<br/>
