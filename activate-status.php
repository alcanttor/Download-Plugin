...
<div id="sm_status" class="wrap pc-wrap dpwap-box-wrap">
	 <div id="mpiblock">
		<div class="postbox">
				<h3 class="hndle"><span><?php esc_html__('Activation Status','dpwap'); ?></span></h3>
				<div class="inside">
					<?php $dpwapObj->dpwap_plugin_all_activate(); 
                    delete_option("dpwap_plugins");?>
				</div>
				<span><a class='' href="plugin-install.php">
					<input type="button" class="button button-primary" value="<?php esc_attr__('Return to Plugin Installer', 'dpwap');?>">
				</span>
			</div>		
		</div>
	</div>
